...
export const DotTangHuyHieuDang = [
  { value: "12/01-02/28", display: "Đợt 1: 1/12 - 28/2", text: "Đợt 1(3 tháng 2)"},
  { value: "03/01-05/31", display: "Đợt 2: 1/3 - 31/5", text: "Đợt 2( 30 tháng 4)"},
  { value: "06/01-09/30", display: "Đợt 3: 1/6 - 30/9", text: "Đợt 3 (2 tháng 9)"},
  { value: "10/01-11/30", display: "Đợt 4: 1/10 - 30/11", text: "Đợt 4 (7 tháng 11)"},
];
export const Dot1 = "02/28";
export const DotTangHuyHieuDangPhuong = [
  { value: "01/01-06/30", display: "Đợt 1: 1/1 - 30/6", text: "Đợt 1(1/1 - 30/6)"},
  { value: "07/01-12/31", display: "Đợt 2: 1/7 - 31/12", text: "Đợt 2(1/7 - 31/12)"}
];
